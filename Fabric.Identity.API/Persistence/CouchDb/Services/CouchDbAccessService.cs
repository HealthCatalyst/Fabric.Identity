...
{
    /// <summary>
    /// TODO: break out ISerializationSettings and ResourceOperationException into separate DLL before splitting CouchDb code into a separate DLL.
    /// </summary>
    public class CouchDbAccessService : IDocumentDbService
    {
        ...
        private static string ReplaceInvalidChars(string documentId)
        {
