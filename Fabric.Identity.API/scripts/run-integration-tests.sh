...
cp ../../Fabric.Identity.SqlServer/bin/Debug/Fabric.Identity.SqlServer_Create.sql ../../Fabric.Identity.IntegrationTests/bin/Debug/netcoreapp2.2/Fabric.Identity.SqlServer_Create.sql
