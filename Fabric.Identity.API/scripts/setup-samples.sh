...
echo "##vso[task.setvariable variable=FABRIC_INSTALLER_SECRET;isOutput=true]$installersecret"
echo ""
...
echo "##vso[task.setvariable variable=AUTH_CLIENT_SECRET;isOutput=true]$authorizationclientsecret"
echo ""
