...
namespace Fabric.Identity.UnitTests
{
    public class ResourceStoreTests
    {
        ...
        [Theory, MemberData(nameof(IdentityResourceScopeData))]
        public void DocumentDbStore_CanFindIdentityResourceByScope(IEnumerable<string> scopeNames, int expectedResultCount)
        {
        ...
        [Theory, MemberData(nameof(ApiResourceScopeData))]
    ...
    {
        public static Mock<IDocumentDbService> SetupGetDocument(this Mock<IDocumentDbService> mockIdentityResourceService,
